 ...
 *
 *****************************************************************************/
/* NOTE: Do NOT enable MLD_CONFIG_NO_ASM on ESP32.
 * ESP32's GCC supports inline asm which is needed for mld_zeroize()
 * and constant-time value barriers. Native backends are already disabled
 * since MLD_CONFIG_USE_NATIVE_BACKEND_ARITH/FIPS202 are not set,
 * and the architecture-specific code has been removed from this port. */
 ...
 *
 *****************************************************************************/
/* ESP32: Use serial FIPS202 to reduce stack usage.
 * The x4 batch mode provides no benefit without SIMD. */
 ...
 *
 *****************************************************************************/
/* ESP32: Reduce RAM usage -- critical for embedded systems with ~320KB RAM.
 * Trades memory for performance. See MLD_TOTAL_ALLOC_* in mldsa_native.h. */
